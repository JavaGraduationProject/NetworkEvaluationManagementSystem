					...
					<form class="form-horizontal" role="form" id="teacherAction" action="teacher" method="post">
						<c:if test="${teacher.teacherId != null }">
							<div class="form-group">
								 <label for="teacherId" class="col-sm-2 control-label">HR编号</label>
								 <div class="col-sm-3">
							...
							<div class="col-sm-5">
								<select class="selectpicker" name="adminPower" id="adminPower" data-live-search="true">
										<c:if test="${teacher == null }">
											<option value="0" style="display: none;">普通HR</option>
										</c:if>
									...
									<option value="0">普通HR</option>	
								</select>
							</div>
						</div>
						<div class="form-group">
							 <label for="teacherName" class="col-sm-2 control-label">HR姓名</label>
							<div class="col-sm-5">
								<input class="form-control" id="teacherName" name="teacherName" type="text" value="${teacher.teacherName }" placeholder="HR姓名" />
							</div>
						</div>
						<div class="form-group">
